...
import 'package:diet_app/module/homepage_module/viewpaln/binding/viewplan_binding.dart';
import 'package:diet_app/module/homepage_module/viewpaln/view/viewplan_view.dart';
import 'package:diet_app/module/homepage_module/weeklyshows/binding/weeklyshows_binding.dart';
import 'package:diet_app/module/homepage_module/weeklyshows/view/weeklyshows_view.dart';
                 ...
                 children: [
                   ...
                   Obx(() => GestureDetector(
                     ...
                     child: GestureDetector(
                       onTap: (){
                         Get.to(ViewplanView(),binding: ViewplanBinding(),);
                       },
                       child: Container(
                         height: 46.h,
                         decoration: BoxDecoration(
                   ...
                   Obx(() => GestureDetector(
                     ...
                     child: GestureDetector(
                       onTap: (){
                         Get.to(WeeklyshowsView(),binding: WeeklyshowsBinding(),);
                       },
                       child: Container(
                         height: 46.h,
                         decoration: BoxDecoration(
