                  ...
                  physics: NeverScrollableScrollPhysics(),
                    ...
                    itemBuilder: (context, index) {
                     ...
                     controller.changecolor.value=index;
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(right: 17.5.w),
                          child: Obx(() => Container(
                            height: 100.h,
                            width: 95.w,
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(12),
                              color: controller.changecolor.value==index?AppColors.Profilecircle:AppColors.whiteTextColor, // Use the color from the item
                            ),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                SvgPicture.asset(controller.mealItems[index].svgAsset, height: 35.h,color: controller.changecolor.value==index?AppColors.whiteTextColor:AppColors.opacityGreyColor,),
                                SizedBox(height: 7.h),
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 11.sp,
                                    fontFamily: ApptextStyle.fontfamily,
                                    color:controller.changecolor.value==index?Colors.white : AppColors.blackTextColor,
                                    fontWeight: FontWeight.w600,
                                  ),
                                ),
                              ],
          ...
          Container(
            ...
            child: TextFormField(
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.search,size: 30,color: AppColors.iconcolor ,),
